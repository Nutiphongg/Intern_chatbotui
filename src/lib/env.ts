...
export const env = {
    ...
    STYLE_CATALOG_URL:getRequiredEnv('STYLE_CATALOG_URL'),
    MEMORY_EMBEDDING_MODEL: getOptionalEnv('MEMORY_EMBEDDING_MODEL', ''),
    MEMORY_SUMMARY_MODEL: getRequiredEnv('MEMORY_SUMMARY_MODEL'),
    MEMORY_RAG_TOP_K: getOptionalEnv('MEMORY_RAG_TOP_K', '6'),
    MEMORY_RAG_MATCH_THRESHOLD: getOptionalEnv('MEMORY_RAG_MATCH_THRESHOLD', '0.2')
};
